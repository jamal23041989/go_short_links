...
func NewStatHandler(r *http.ServeMux, deps StatHandlerDeps) {
	handler := &StatHandler{
		StatRepository: deps.StatRepository,
	}

	r.Handle("GET /stat", middleware.IsAuthed(handler.GetStat(), deps.Config))
}
...
func (h *StatHandler) GetStat() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		resp.Json(w, stats, http.StatusOK)
	}
}
